                    ...
                    <div class="tab-content">
                        ...
                        <div class="tab-pane" id="ficheros" role="tabpanel" aria-expanded="false">
                            <div class="form-group row">
                                <label class="col-md-3 form-control-label" for="file-input">Multiple File input</label>
                                <div class="col-md-9">
                                    <input type="file" id="file-input" name="file--input" multiple="">
                                </div>
                            </div>
                            <div class="form-group col-sm-6">
                                <label for="organica">Título</label>
                                <input class="form-control" name="organica" value="">
                            </div>
                            <div class="form-group col-sm-6">
                                <label for="economica">Descripción</label>
                                <input class="form-control" name="economica" value="">
                            </div>
